...
class MjSpec:
    ...
    def attach(self, child: MjSpec, prefix: str | None = ..., frame: Any = ...) -> Any: ...
...
class Renderer:
    def __init__(
        self, model: MjModel, height: int = ..., width: int = ..., max_geom: int | None = ...
    ) -> None: ...
    def update_scene(
        self,
        data: MjData,
...
def mj_ray(model: MjModel, data: MjData, pnt: Any, vec: Any, geomgroup: Any, flg_static: int, bodyexclude: int, geomid: Any) -> float: ...
