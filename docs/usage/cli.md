...
(doc-usage-cli-configuration-precedence)=
...
(doc-usage-cli-commands)=

## Commands

(doc-usage-cli-dimos-run)=
...
| Option           | Description                                                                                  |
| ---------------- | -------------------------------------------------------------------------------------------- |
| `--config` `-c`  | Path to read JSON config file from (options can be overridden with `-o`                      |
...
(doc-usage-cli-adding-a-new-blueprint)=
...
(doc-usage-cli-dimos-show-config)=
...
(doc-usage-cli-agent-mcp-commands)=

## Agent & MCP Commands

(doc-usage-cli-dimos-agent-send)=
...
(doc-usage-cli-dimos-mcp-list-tools)=
...
(doc-usage-cli-dimos-mcp-status)=
...
(doc-usage-cli-dimos-mcp-modules)=
