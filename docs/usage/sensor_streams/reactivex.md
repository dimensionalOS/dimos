...
myst:
  substitutions:
    output: |-
      ```{image} assets/observable_flow.svg
      ```
---

(doc-usage-sensor-streams-reactivex-reactivex-rxpy-quick-reference)=

# ReactiveX (RxPY) Quick Reference

(doc-usage-sensor-streams-reactivex-reactivex-rxpy-quick-reference-1)=

# ReactiveX (RxPY) Quick Reference

RxPY provides composable asynchronous data streams. This is a practical guide focused on common patterns in this codebase.

(doc-usage-sensor-streams-reactivex-quick-start-using-an-observable)=
...
(doc-usage-sensor-streams-reactivex-the-pipe-pattern)=
...
(doc-usage-sensor-streams-reactivex-common-operators)=

## Common Operators

(doc-usage-sensor-streams-reactivex-transform-map)=
...
(doc-usage-sensor-streams-reactivex-filter-filter)=
...
(doc-usage-sensor-streams-reactivex-limit-emissions-take)=
...
(doc-usage-sensor-streams-reactivex-flatten-nested-observables-flat-map)=
...
(doc-usage-sensor-streams-reactivex-rate-limiting)=

## Rate Limiting

(doc-usage-sensor-streams-reactivex-sampleinterval-emit-latest-value-every-n-seconds)=
...
(doc-usage-sensor-streams-reactivex-throttle-firstinterval-emit-first-then-block-for-n-seconds)=
...
(doc-usage-sensor-streams-reactivex-difference-between-sample-and-throttle-first)=
...
(doc-usage-sensor-streams-reactivex-what-is-an-observable)=
...
(doc-usage-sensor-streams-reactivex-disposables-cancelling-subscriptions)=
...
(doc-usage-sensor-streams-reactivex-creating-observables)=
...
(doc-usage-sensor-streams-reactivex-from-registerunregister-apis)=
...
(doc-usage-sensor-streams-reactivex-from-subscribe-returns-unsub-apis)=
...
(doc-usage-sensor-streams-reactivex-from-scratch-with-rxcreate)=
...
(doc-usage-sensor-streams-reactivex-compositedisposable)=
...
(doc-usage-sensor-streams-reactivex-reference)=
