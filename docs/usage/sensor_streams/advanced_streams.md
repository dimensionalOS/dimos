...
myst:
  substitutions:
    image1: |-
      ```{image} assets/backpressure_solution.svg
      ```
    image2: |-
      ```{image} assets/getter_hot_cold.svg
      ```
    output: |-
      ```{image} assets/backpressure.svg
      ```
---

(doc-usage-sensor-streams-advanced-streams-advanced-stream-handling)=

# Advanced Stream Handling

(doc-usage-sensor-streams-advanced-streams-advanced-stream-handling-1)=

# Advanced Stream Handling

**Prerequisite:** Read [ReactiveX Fundamentals](reactivex.md) first for Observable basics.

(doc-usage-sensor-streams-advanced-streams-backpressure-and-parallel-subscribers-to-hardware)=
...
(doc-usage-sensor-streams-advanced-streams-how-it-works)=
...
(doc-usage-sensor-streams-advanced-streams-usage-in-modules)=
...
(doc-usage-sensor-streams-advanced-streams-getting-values-synchronously)=
...
(doc-usage-sensor-streams-advanced-streams-getter-hot-background-subscription-instant-reads)=
...
(doc-usage-sensor-streams-advanced-streams-getter-cold-fresh-subscription-each-call)=
