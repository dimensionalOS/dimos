...
myst:
  substitutions:
    image1: |-
      ...
      ```
    image2: |-
      ```{image} https://raw.githubusercontent.com/dimensionalOS/dimos-docs-assets/main/usage/sensor_streams/assets/frame_mosaic2.jpg
      ```
    image3: |-
      ```{image} assets/sharpness_graph2.svg
      ```
    output: |-
      ```{image} https://raw.githubusercontent.com/dimensionalOS/dimos-docs-assets/main/usage/sensor_streams/assets/frame_mosaic.jpg
      ```
---

(doc-usage-sensor-streams-quality-filter-quality-based-stream-filtering)=

# Quality-Based Stream Filtering

(doc-usage-sensor-streams-quality-filter-quality-based-stream-filtering-1)=
...
(doc-usage-sensor-streams-quality-filter-image-sharpness-filtering)=
...
(doc-usage-sensor-streams-quality-filter-usage-in-camera-module)=
...
(doc-usage-sensor-streams-quality-filter-how-sharpness-is-calculated)=
...
(doc-usage-sensor-streams-quality-filter-custom-quality-functions)=
...
(doc-usage-sensor-streams-quality-filter-api-reference)=

## API Reference

(doc-usage-sensor-streams-quality-filter-quality-barrierquality-func-target-frequency)=
...
(doc-usage-sensor-streams-quality-filter-sharpness-barriertarget-frequency)=
