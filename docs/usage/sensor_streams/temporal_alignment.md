...
myst:
  substitutions:
    image1: |-
      ```{image} https://raw.githubusercontent.com/dimensionalOS/dimos-docs-assets/main/usage/sensor_streams/assets/alignment_timeline.png
      ```
    image2: |-
      ```{image} https://raw.githubusercontent.com/dimensionalOS/dimos-docs-assets/main/usage/sensor_streams/assets/alignment_timeline2.png
      ```
    image3: |-
      ```{image} https://raw.githubusercontent.com/dimensionalOS/dimos-docs-assets/main/usage/sensor_streams/assets/alignment_timeline3.png
      ```
    image4: |-
      ```{image} assets/alignment_flow.svg
      ```
    output: |-
      ```{image} assets/alignment_overview.svg
      ```
---

(doc-usage-sensor-streams-temporal-alignment-temporal-message-alignment)=

# Temporal Message Alignment

(doc-usage-sensor-streams-temporal-alignment-temporal-message-alignment-1)=
...
(doc-usage-sensor-streams-temporal-alignment-basic-usage)=
...
(doc-usage-sensor-streams-temporal-alignment-combine-frame-alignment-with-a-quality-filter)=
...
(doc-usage-sensor-streams-temporal-alignment-how-it-works)=
...
(doc-usage-sensor-streams-temporal-alignment-parameters)=
...
(doc-usage-sensor-streams-temporal-alignment-usage-in-modules)=
