...
myst:
  substitutions:
    image1: |-
      ```{image} assets/sharpness_graph.svg
      ```
    image2: |-
      ```{image} https://raw.githubusercontent.com/dimensionalOS/dimos-docs-assets/main/usage/data_streams/assets/frame_mosaic2.jpg
      ```
    image3: |-
      ```{image} assets/sharpness_graph2.svg
      ```
    output: |-
      ```{image} https://raw.githubusercontent.com/dimensionalOS/dimos-docs-assets/main/usage/data_streams/assets/frame_mosaic.jpg
      ```
---

(doc-usage-data-streams-quality-filter-quality-based-stream-filtering)=

# Quality-Based Stream Filtering

(doc-usage-data-streams-quality-filter-quality-based-stream-filtering-1)=
...
(doc-usage-data-streams-quality-filter-the-problem)=
...
(doc-usage-data-streams-quality-filter-the-solution-quality-barrier)=
...
(doc-usage-data-streams-quality-filter-image-sharpness-filtering)=
...
Let's use real camera data from the Unitree Go2 robot to demonstrate. We use the [Sensor Storage & Replay](../sensor_streams/storage_replay.md) toolkit, which provides access to recorded robot data:
...
(doc-usage-data-streams-quality-filter-usage-in-camera-module)=
...
(doc-usage-data-streams-quality-filter-how-sharpness-is-calculated)=

### How Sharpness is Calculated

The sharpness score (0.0 to 1.0) is computed using Sobel edge detection:

from [Image.py](https://github.com/dimensionalOS/dimos/blob/main/dimos/msgs/sensor_msgs/Image.py)
...
(doc-usage-data-streams-quality-filter-custom-quality-functions)=
...
(doc-usage-data-streams-quality-filter-api-reference)=

## API Reference

(doc-usage-data-streams-quality-filter-quality-barrierquality-func-target-frequency)=
...
(doc-usage-data-streams-quality-filter-sharpness-barriertarget-frequency)=
