...
myst:
  substitutions:
    image1: |-
      ```{image} https://raw.githubusercontent.com/dimensionalOS/dimos-docs-assets/main/usage/data_streams/assets/alignment_timeline.png
      ```
    image2: |-
      ```{image} https://raw.githubusercontent.com/dimensionalOS/dimos-docs-assets/main/usage/data_streams/assets/alignment_timeline2.png
      ```
    image3: |-
      ```{image} https://raw.githubusercontent.com/dimensionalOS/dimos-docs-assets/main/usage/data_streams/assets/alignment_timeline3.png
      ```
    image4: |-
...
(doc-usage-data-streams-temporal-alignment-temporal-message-alignment)=

# Temporal Message Alignment

(doc-usage-data-streams-temporal-alignment-temporal-message-alignment-1)=
...
(doc-usage-data-streams-temporal-alignment-basic-usage)=
...
(doc-usage-data-streams-temporal-alignment-combine-frame-alignment-with-a-quality-filter)=
...
(doc-usage-data-streams-temporal-alignment-how-it-works)=
...
(doc-usage-data-streams-temporal-alignment-parameters)=
...
(doc-usage-data-streams-temporal-alignment-usage-in-modules)=
