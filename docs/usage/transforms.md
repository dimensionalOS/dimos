...
myst:
  substitutions:
    image1: |-
      ```{image} assets/transforms_modules.svg
      ```
    output: |-
      ```{image} assets/transforms_tree.svg
      ```
    transforms: |-
      ```{image} https://raw.githubusercontent.com/dimensionalOS/dimos-docs-assets/main/usage/assets/transforms.png
      ```
---

(doc-usage-transforms-transforms)=

# Transforms

(doc-usage-transforms-the-problem-everything-measures-from-its-own-perspective)=
...
(doc-usage-transforms-whats-a-coordinate-frame)=
...
(doc-usage-transforms-the-transform-class)=
...
(doc-usage-transforms-transform-operations)=
...
(doc-usage-transforms-converting-to-matrix-form)=
...
(doc-usage-transforms-frame-ids-in-modules)=
...
(doc-usage-transforms-the-tf-service)=
...
The TF service is implemented in [protocol/tf/tf.py](https://github.com/dimensionalOS/dimos/blob/main/dimos/protocol/tf/tf.py) and is lazily initialized on first access.

(doc-usage-transforms-multi-module-transform-example)=
...
(doc-usage-transforms-internals)=

## Internals

(doc-usage-transforms-transform-buffer)=
...
(doc-usage-transforms-further-reading)=
