(doc-usage-visualization-viewer-backends)=

# Viewer Backends

DimOS uses Rerun for visualizations. It can be disabled by using `dimos --viewer none ...`.

Blueprints add Rerun stream visualization with `vis_module(...)`, which renders typed robot streams according to `GlobalConfig.viewer`.

(doc-usage-visualization-quick-start)=
...
(doc-usage-visualization-viewer-modes-explained)=

## Viewer Modes Explained

(rerun-native-rerun-rerun-open-native-default)=

(doc-usage-visualization-rerun-native-rerun-rerun-open-native-default)=
...
(doc-usage-visualization-rerun-web-rerun-rerun-open-web)=
...
(doc-usage-visualization-rendering-with-custom-blueprints)=
...
(doc-usage-visualization-symptom-slow-map-updates)=
...
(doc-usage-visualization-increase-voxel-size)=

### Increase Voxel Size

Edit [dimos/robot/unitree/go2/blueprints/smart/unitree_go2.py](https://github.com/dimensionalOS/dimos/blob/main/dimos/robot/unitree/go2/blueprints/smart/unitree_go2.py):
...
(doc-usage-visualization-direct-visualization-from-a-module)=
