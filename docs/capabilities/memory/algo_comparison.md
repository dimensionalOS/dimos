...
myst:
  substitutions:
    image1: |-
      ```{image} https://raw.githubusercontent.com/dimensionalOS/dimos-docs-assets/main/capabilities/memory/assets/plot_brightness_algo_delta.svg
      ```
    output: |-
      ```{image} https://raw.githubusercontent.com/dimensionalOS/dimos-docs-assets/main/capabilities/memory/assets/plot_brightness_algo.svg
      ```
---

(doc-capabilities-memory-algo-comparison-iterate-the-source-once-all-five-series-below-read-from-the-cache)=
