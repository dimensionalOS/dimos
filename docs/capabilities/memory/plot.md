...
myst:
  substitutions:
    image1: |-
      ```{image} https://raw.githubusercontent.com/dimensionalOS/dimos-docs-assets/main/capabilities/memory/assets/plot_named.svg
      ```
    image10: |-
      ```{image} https://raw.githubusercontent.com/dimensionalOS/dimos-docs-assets/main/capabilities/memory/assets/plants_meaningful.png
      ```
    image11: |-
      ```{image} https://raw.githubusercontent.com/dimensionalOS/dimos-docs-assets/main/capabilities/memory/assets/peak_space.svg
      ```
    image12: |-
      ```{image} https://raw.githubusercontent.com/dimensionalOS/dimos-docs-assets/main/capabilities/memory/assets/plants_peak_detections.png
      ```
    image13: |-
      ```{image} https://raw.githubusercontent.com/dimensionalOS/dimos-docs-assets/main/capabilities/memory/assets/peak_detections.svg
      ```
    image2: |-
      ```{image} https://raw.githubusercontent.com/dimensionalOS/dimos-docs-assets/main/capabilities/memory/assets/plot_robot_data.svg
      ```
    image3: |-
      ```{image} https://raw.githubusercontent.com/dimensionalOS/dimos-docs-assets/main/capabilities/memory/assets/plot_plantness.svg
      ```
    image4: |-
      ```{image} https://raw.githubusercontent.com/dimensionalOS/dimos-docs-assets/main/capabilities/memory/assets/plot_plantness_brightness.svg
      ```
    image5: |-
      ```{image} https://raw.githubusercontent.com/dimensionalOS/dimos-docs-assets/main/capabilities/memory/assets/plot_plantness_gap_fill.svg
      ```
    image6: |-
      ```{image} https://raw.githubusercontent.com/dimensionalOS/dimos-docs-assets/main/capabilities/memory/assets/plot_plantness_autopeaks.svg
      ```
    image7: |-
      ```{image} https://raw.githubusercontent.com/dimensionalOS/dimos-docs-assets/main/capabilities/memory/assets/plants_auto.png
      ```
    image8: |-
      ```{image} https://raw.githubusercontent.com/dimensionalOS/dimos-docs-assets/main/capabilities/memory/assets/plot_plantness_autopeaks_map.svg
      ```
    image9: |-
      ```{image} https://raw.githubusercontent.com/dimensionalOS/dimos-docs-assets/main/capabilities/memory/assets/plot_plantness_significant.svg
      ```
    output: |-
      ```{image} https://raw.githubusercontent.com/dimensionalOS/dimos-docs-assets/main/capabilities/memory/assets/plot_colors.svg
      ```
---

(doc-capabilities-memory-plot-plot)=

# Plot

(doc-capabilities-memory-plot-color-cycle)=
...
(doc-capabilities-memory-plot-speed-plot)=
...
(doc-capabilities-memory-plot-semantic-search)=
...
{{ image4 }} We see that stuff isn't embedded below some minimum brightness.
...
(doc-capabilities-memory-plot-which-peaks-are-significant)=
...
(doc-capabilities-memory-plot-3d-projection)=
...
(doc-capabilities-memory-plot-todo-further-steps)=
