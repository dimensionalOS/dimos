(doc-capabilities-manipulation-a750-a-750-robotic-arm)=
...
(doc-capabilities-manipulation-a750-quick-start)=
...
| Module                                                                                            | Role                                                                                                                      |
| ------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------- |
| [`KeyboardTeleopModule`][KeyboardTeleopModule] | Publishes routed spatial EEF twist intent from the keyboard UI                                                            |
| [`ControlCoordinator`][ControlCoordinator]                        | Runs a 100 Hz coordinator loop and [`EEFTwistTask`][EEFTwistTask] |
| [`ManipulationModule`][ManipulationModule]           | Loads the A-750 robot model in Drake and serves Meshcat visualization                                                     |

Open the Meshcat URL printed in the terminal, usually `http://localhost:7000`, to view the robot.

(doc-capabilities-manipulation-a750-real-hardware)=
...
(doc-capabilities-manipulation-a750-robot-model)=

## Robot Model

The robot model and hardware config are defined in [dimos/robot/manipulators/a750/config.py](https://github.com/dimensionalOS/dimos/blob/main/dimos/robot/manipulators/a750/config.py). The runnable keyboard teleop stack is composed in [dimos/robot/manipulators/a750/blueprints/teleop.py](https://github.com/dimensionalOS/dimos/blob/main/dimos/robot/manipulators/a750/blueprints/teleop.py).
...
(doc-capabilities-manipulation-a750-gripper)=
...
(doc-capabilities-manipulation-a750-hardware-adapter)=

## Hardware Adapter

The adapter is registered as `a750` in [dimos/hardware/manipulators/a750/adapter.py](https://github.com/dimensionalOS/dimos/blob/main/dimos/hardware/manipulators/a750/adapter.py#L40).
...
(doc-capabilities-manipulation-a750-control-path)=

## Control Path

The `keyboard-teleop-a750` blueprint is defined in [dimos/robot/manipulators/a750/blueprints/teleop.py](https://github.com/dimensionalOS/dimos/blob/main/dimos/robot/manipulators/a750/blueprints/teleop.py).
...
(doc-capabilities-manipulation-a750-keyboard-controls)=
...
(doc-capabilities-manipulation-a750-known-limitations)=
...
[KeyboardTeleopModule]: #dimos.teleop.keyboard.keyboard_teleop_module.KeyboardTeleopModule
[ControlCoordinator]: #dimos.control.coordinator.ControlCoordinator
[EEFTwistTask]: #dimos.control.tasks.eef_twist_task.eef_twist_task.EEFTwistTask
