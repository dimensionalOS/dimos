...
The adapter is registered as `a750` through the manipulator adapter manifest in [`dimos/hardware/manipulators/a750/_registry.py`](/dimos/hardware/manipulators/a750/_registry.py#L16).
