(doc-capabilities-manipulation-openarm-integration-openarm-integration)=

# OpenArm Integration

(doc-capabilities-manipulation-openarm-integration-openarm-integration-1)=
...
(doc-capabilities-manipulation-openarm-integration-why-this-integration-is-different)=
...
(doc-capabilities-manipulation-openarm-integration-architecture)=
...
Workspace analysis is generic and lives in [dimos/utils/workspace.py](https://github.com/dimensionalOS/dimos/blob/main/dimos/utils/workspace.py) — works for any URDF, not just OpenArm.

______________________________________________________________________

(doc-capabilities-manipulation-openarm-integration-quick-start)=
...
(bring-up-the-can-buses)=

(doc-capabilities-manipulation-openarm-integration-1-bring-up-the-can-buses)=
...
(verify-all-16-motors-are-alive)=

(doc-capabilities-manipulation-openarm-integration-2-verify-all-16-motors-are-alive)=
...
(first-time-only-put-motors-in-mit-mode)=

(doc-capabilities-manipulation-openarm-integration-3-first-time-only-put-motors-in-mit-mode)=
...
(doc-capabilities-manipulation-openarm-integration-4-run-a-blueprint)=
...
(drive-the-arms-from-the-manipulation-client)=

(doc-capabilities-manipulation-openarm-integration-5-drive-the-arms-from-the-manipulation-client)=
...
(doc-capabilities-manipulation-openarm-integration-example-session-simple-joint-moves)=
...
(doc-capabilities-manipulation-openarm-integration-example-session-bimanual)=
...
(doc-capabilities-manipulation-openarm-integration-example-session-cartesian-target)=
...
(doc-capabilities-manipulation-openarm-integration-configuration)=

## Configuration

(doc-capabilities-manipulation-openarm-integration-which-can-bus-is-which-arm)=

### Which CAN bus is which arm

Linux assigns `can0`/`can1` in USB-enumeration order, which isn't guaranteed stable across reboots or cable swaps. If the arms come up "swapped" (commanding `left_arm` moves the physical right arm), flip these two constants in [config.py](https://github.com/dimensionalOS/dimos/blob/main/dimos/robot/manipulators/openarm/config.py):
...
(doc-capabilities-manipulation-openarm-integration-gain-tuning-mit-kpkd)=

### Gain tuning (MIT kp/kd)

Defaults live in [adapter.py](https://github.com/dimensionalOS/dimos/blob/main/dimos/hardware/manipulators/openarm/adapter.py). Gains are per-joint because the shoulder motors (DM8006, 40 Nm) tolerate higher kp than the wrist motors (DM4310, 10 Nm):
...
(doc-capabilities-manipulation-openarm-integration-physical-joint-limits)=
...
(doc-capabilities-manipulation-openarm-integration-damiao-protocol-essentials)=
...
(doc-capabilities-manipulation-openarm-integration-enable-disable-zero-position)=
...
(doc-capabilities-manipulation-openarm-integration-mit-control-frame-8-bytes)=
...
(doc-capabilities-manipulation-openarm-integration-state-reply-8-bytes-on-recv-id)=
...
(doc-capabilities-manipulation-openarm-integration-ctrl-mode-register-write)=
...
(doc-capabilities-manipulation-openarm-integration-known-gotchas)=
...
- **Arms swap sides.** USB enumeration order flipped. Swap `LEFT_CAN` / `RIGHT_CAN` in [config.py](https://github.com/dimensionalOS/dimos/blob/main/dimos/robot/manipulators/openarm/config.py).

______________________________________________________________________

(doc-capabilities-manipulation-openarm-integration-design-decisions)=
...
(doc-capabilities-manipulation-openarm-integration-workspace-analysis)=
...
(doc-capabilities-manipulation-openarm-integration-testing)=
