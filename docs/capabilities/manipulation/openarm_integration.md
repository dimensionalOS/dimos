...
dimos run openarm-planner-coordinator --connection.left-can-port can1 --connection.right-can-port can0
...
both `--connection.left-can-port` and `--connection.right-can-port` selects the physical adapter.
