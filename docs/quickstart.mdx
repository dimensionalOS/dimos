...
<CardGroup cols={2}>
  <Card title="Add an LLM agent" href="/capabilities/agents/readme" icon="robot">
    Natural language control and MCP-exposed skills.
  </Card>
  <Card title="Pick your platform" href="/platforms/quadruped/go2/index" icon="microchip">
    Hardware support matrix and bring-up guides.
  </Card>
  <Card title="Core concepts" href="/usage/README" icon="diagram-project">
