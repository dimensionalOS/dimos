...
| OS Guide | Notes |
| --- | --- |
| <Icon icon="ubuntu" iconType="brands" size={18} />  [Ubuntu](/docs/installation/ubuntu.md) | Primary tested path |
| <Icon icon="snowflake" iconType="solid" size={18} /> [Nix](/docs/installation/nix.md) | Flakes and dev shell |
| <Icon icon="apple" iconType="brands" size={18} /> [macOS](/docs/installation/osx.md) | Homebrew-based; less mature than Linux |
...
On first run, the Rerun window may stay black briefly while roughly **75 MB** of
recorded data downloads from the pinned public dataset.
...
Do not skip the platform guide - latency, time sync, and safety habits matter: [Unitree Go2](/docs/platforms/quadruped/go2/index.md).
...
Blueprint reference: [Blueprints](/docs/usage/blueprints.md).
...
Full reference: [CLI](/docs/usage/cli.md).
