(doc-development-releasing-releasing)=
...
(doc-development-releasing-1-preparing-for-a-release)=
...
(doc-development-releasing-2-creating-the-release)=
...
(doc-development-releasing-3-cleanup)=
...
(doc-development-releasing-patch-fix-on-a-released-version)=
...
(doc-development-releasing-verifying-a-release-tag)=
...
(doc-development-releasing-rotating-the-app-private-key)=
...
(doc-development-releasing-rotating-the-gpg-signing-key)=

### Rotating the GPG signing key

Rotate immediately on suspected compromise. Sam/Stash have revocation certificates which can be published to revoke the old key.
