(doc-coding-agents-style-code-style-guidelines)=

# Code Style Guidelines

Rules for writing code in dimos. These address recurring issues found in code review.

(doc-coding-agents-style-no-comment-banners)=
...
(no-init-py-re-exports)=

(doc-coding-agents-style-no-init-py-re-exports)=
