(doc-coding-agents-testing-testing-guidelines)=
...
(doc-coding-agents-testing-always-clean-up-resources)=
...
(doc-coding-agents-testing-no-conditional-logic-in-assertions)=
...
(doc-coding-agents-testing-print-statements)=

## Print statements

- **Unit tests**: no prints. Use assertions.
- **\`\`tool\_\*.py\`\` files** (integration/exploration tools): prints are fine for progress and inspection output.

(doc-coding-agents-testing-avoid-unnecessary-sleeps)=
...
(doc-coding-agents-testing-private-fields)=
...
(doc-coding-agents-testing-type-ignores)=
