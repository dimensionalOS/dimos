...
DimOS is a modular framework for building LLM-controlled robots. In this quickstart, you'll learn the basics of DimOS by building an LLM agent that can make greetings. In particular, we'll define a greeting *skill* on a `Module`, and equip an *agent* with that skill.
...
You now have a robot that you can ask for greetings -- in ordinary English!
...
- [Build your first skill](tutorials/skill_basics/tutorial.md): A more detailed tutorial on how to build a skill -- and how the blueprint system works
