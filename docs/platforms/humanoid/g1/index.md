(doc-platforms-humanoid-g1-index-unitree-g1)=

# Unitree G1

(doc-platforms-humanoid-g1-index-requirements)=
...
(doc-platforms-humanoid-g1-index-1-get-ssh-access)=

## 1. Get SSH Access

(doc-platforms-humanoid-g1-index-get-ethernet-working)=
...
(doc-platforms-humanoid-g1-index-use-ethernet-to-get-wifi-working)=

### Use Ethernet to get WiFi Working

After connecting over SSH, find additional IP addresses:
...
(doc-platforms-humanoid-g1-index-network-interface-names)=
...
(doc-platforms-humanoid-g1-index-remote-network)=

### Remote Network

Set up [Tailscale](https://tailscale.com/tailscale-ssh) to avoid
router-specific configuration for wireless control.

(install-dimos)=

(doc-platforms-humanoid-g1-index-2-install-dimos)=
...
(doc-platforms-humanoid-g1-index-notes)=
...
(get-the-g1-in-sport-mode)=

(doc-platforms-humanoid-g1-index-3-get-the-g1-in-sport-mode)=
...
(doc-platforms-humanoid-g1-index-4-run-the-blueprint)=
...
(doc-platforms-humanoid-g1-index-troubleshooting)=

### Troubleshooting

(doc-platforms-humanoid-g1-index-keyboard-controls-not-working)=
...
(doc-platforms-humanoid-g1-index-viewer-crashing)=
...
(doc-platforms-humanoid-g1-index-external-resources)=
