...
1. On the G1 (ssh connection) change `_VIS_THROTTLE = 0.5` (inside `dimos/robot/unitree/g1/blueprints/primitive/unitree_g1_vis.py`) to a lower number, like 0.3 or 0.2
2. Get more RAM
