(doc-platforms-quadruped-go2-setup-unitree-go2-setup)=

# Unitree Go2 — Setup

(unitree-go2-setup-1)=

(doc-platforms-quadruped-go2-setup-unitree-go2-setup-1)=

## Unitree Go2 — Setup

Full autonomous navigation, mapping, and agentic control on a real Go2 — no ROS required.

(doc-platforms-quadruped-go2-setup-requirements)=
...
(doc-platforms-quadruped-go2-setup-install)=
...
(doc-platforms-quadruped-go2-setup-run-on-your-go2)=

## Run on Your Go2

(doc-platforms-quadruped-go2-setup-first-time-setup-connecting-to-wifi-finding-robot-ip)=
...
(doc-platforms-quadruped-go2-setup-pre-flight-checks)=
...
(doc-platforms-quadruped-go2-setup-ready-to-run-dimos)=
...
(doc-platforms-quadruped-go2-setup-whats-running)=
...
(doc-platforms-quadruped-go2-setup-send-goals)=
...
(doc-platforms-quadruped-go2-setup-agentic-control)=
