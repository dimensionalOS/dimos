...
The installer sets up Homebrew dependencies, uv, Python 3.12, and dimOS. Choose **library** for the published package or **dev** for a source checkout. Select navigation, manipulation, or both, and follow the printed activation command when it finishes.
