/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 30a6c7e1c022078d071cf89e478c5756)
// Runtime types generated with workerd@1.20260825.1 2026-09-09 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	REQUEST_LIMITER: RateLimit;
	ASSETS: Fetcher;
	PUBLIC_ORIGIN: "https://sim.tule.world";
	GITHUB_CLIENT_ID: "Ov23lifchwSuJsZK26hd";
	ADMIN_GITHUB_IDS: "6902572";
	MATCH_ID: "football-v1";
	GITHUB_CLIENT_SECRET: string;
	HOST_SECRET: string;
	MATCH: DurableObjectNamespace<import("./src/index").MatchRelay>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "MatchRelay";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_ORIGIN" | "GITHUB_CLIENT_ID" | "ADMIN_GITHUB_IDS" | "MATCH_ID" | "GITHUB_CLIENT_SECRET" | "HOST_SECRET">> {}
}
