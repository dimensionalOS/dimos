...
**Spatial arm teleoperation**:
Arm teleoperation in which tracked WebXR input sources provide clutched, relative Cartesian pose commands and gripper input.
_Avoid_: Keyboard teleoperation, leader-follower teleoperation

**Operator hand**:
The left or right WebXR input source as a source of teleoperation intent, independent of the robot arm it controls.
_Avoid_: Hand, side
