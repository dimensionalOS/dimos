...
MISSION = (
    ...
    "search plan forms you up abreast of your partner with a 2 m overlap "
    "between your radar footprints, so nothing slips between you. ACT NOW in a "
    "single response: call BOTH claim_sector (your half — don't overlap your "
    "partner's claim) AND begin_coordinated_search. Then react to every [SENSOR] and [RADIO] "
