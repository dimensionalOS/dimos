...
class VisualServoing:
    ...
    def __init__(
        ...
        self.controller = VisualServoingController(
            distance_pid_params=distance_pid_params, angle_pid_params=angle_pid_params
        )
    ...
    def start_tracking(
        self,
        desired_distance: int = None,
        point: Tuple[int, int] = None,
        timeout_wait_for_target: float = 20.0,
    ) -> bool:
        """
