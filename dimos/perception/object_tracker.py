...
class ObjectTrackingStream:
    ...
    def create_stream(self, video_stream: Observable) -> Observable:
        ...
        def process_frame(frame):
                ...
                if not self.tracking_initialized:
                    ...
                    if success:
                        ...
                        if (
                            ...
                            and self.distance_estimator.estimated_object_size
                            is not None
                        ):
                            distance, angle = (
                                self.distance_estimator.estimate_distance_angle(bbox)
                            )
                        ...
                        text_size = cv2.getTextSize(
                            dist_text, cv2.FONT_HERSHEY_SIMPLEX, 0.5, 2
                        )[0]
            ...
            return {"frame": frame, "viz_frame": viz_frame, "targets": []}
