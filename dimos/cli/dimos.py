...
from dimos.cli.cloud import app as cloud_app, login as cloud_login
...
main.add_typer(cloud_app, name="cloud")
# `dimos login` is the front door; the rest lives under `dimos cloud`.
