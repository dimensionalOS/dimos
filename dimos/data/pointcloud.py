...
class PointCloudProcessor:
    def __init__(self, output_dir, intrinsic_parameters=None):
        ...
        self.intrinsic_parameters = (
            ...
            else self.default_intrinsic_parameters
        )
    ...
    def process_frame(self, image, depth_map, masks):
        ...
        try:
            ...
            original_pcd = create_point_cloud_from_rgbd(
                original_image_cv, depth_image_cv, intrinsic_parameters
            )
            pcd, canonicalized, transformation = canonicalize_point_cloud(
            ...
            for idx, mask in enumerate(masks):
                ...
                point_clouds.append(
                    PointCloudType(
                        point_cloud=inlier_cloud, metadata={"mask_index": idx}
                    )
                )
