...
"""Host-side validation for the official runtime artifact."""
...
def validate_native_result(
    ...
    *,
    ...
    """Validate exact attempt identity and official values without rescoring."""
    try:
    ...
    expected = {"attempt_id": attempt_id, "case_id": case.case_id}
