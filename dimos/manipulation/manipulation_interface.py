...
class ManipulationInterface:
    ...
    def __init__(
        ...
        # List of constraints generated by the Agent via constraint generation tools
    ...
    def add_constraint(self, constraint: AbstractConstraint) -> None:
        """
        Add a constraint generated by the Agent via a constraint generation tool.
    ...
    def get_constraints(self) -> list[AbstractConstraint]:
        """
        Get all constraints generated by the Agent via constraint generation tools.
