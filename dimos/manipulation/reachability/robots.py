...
plus the joints and end-effector body that define one arm. construct and
the viewer are robot-agnostic — this module is the only place that knows
about a specific robot, so adding one is a single registry entry.
