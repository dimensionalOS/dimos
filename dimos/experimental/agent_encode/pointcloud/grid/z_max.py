...
class ZMax(Query[Grid]):
    """The highest z in each cell's column; NaN where there is no return."""
    ...
    def run(self, cloud: PointCloud2) -> Grid:
        ...
        return Grid(binned.origin, self.cell_m, binned.rows(binned.highest()), cloud)
