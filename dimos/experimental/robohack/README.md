...
→ Full detail in **[IDEAS.md](./IDEAS.md)**. Study reference in **[CHEATSHEET.md](./CHEATSHEET.md)**. Application blurbs in **[PITCH.md](./PITCH.md)**. **Setup + on-site steps in [RUNBOOK.md](./RUNBOOK.md).** Hands-on, VPS-verified notes + `@skill` template in **[learn/](./learn/LEARNINGS.md)**.
