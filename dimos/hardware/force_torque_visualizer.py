            ...
            try:
                ...
                try:
                    ...
                    if "forces" in data and "torques" in data:
                        ...
                        self.force_magnitudes.append(
                            data.get("force_magnitude", np.linalg.norm(forces))
                        )
                        self.torque_magnitudes.append(
                            data.get("torque_magnitude", np.linalg.norm(torques))
                        )
                        ...
                        try:
                            ...
                            self.data_queue.put_nowait(
                                {"timestamp": rel_time, "forces": forces, "torques": torques}
                            )
                        except queue.Full:
                            pass
