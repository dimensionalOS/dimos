...
from dimos.hardware.can import gs_usb_bus

# Arbitrary adapter USB IDs for tests (candlelight CANable 2.0)
_TEST_VENDOR_ID = 0x1D50
_TEST_PRODUCT_ID = 0x606F
