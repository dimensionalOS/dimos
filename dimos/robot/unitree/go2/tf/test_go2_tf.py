...
def _config() -> GO2ZenohConfig:
    return GO2ZenohConfig(mid360_mount_rpy_deg=tuple(Go2TfConfig().mid360_mount_rpy_deg))
...
def test_the_geometry_defaults_are_the_rig_go2zenoh_measures():
    ...
    assert tuple(config.mid360_mount_rpy_deg) == GO2ZenohConfig().mid360_mount_rpy_deg
