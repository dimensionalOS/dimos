...
def make_a1z_policy_blueprint(
    ...
    *,
    ...
    from dimos.experimental.robot_policy.lerobot import LeRobotPolicyConfig
...
def make_a1z_learned_policy_blueprint(
    ...
    *,
    ...
    selected_policy_module = policy_module or LeRobotPolicyModule
    hardware = a1z_hardware(
        "arm",
        has_gripper=True,
        dynamics_urdf_path=A1Z_G1Z_MODEL_PATH,
    ...
    return autoconnect(
        ...
        selected_policy_module.blueprint(
            policies=policies,
            joint_names=hardware.all_joints,
            fps=fps,
