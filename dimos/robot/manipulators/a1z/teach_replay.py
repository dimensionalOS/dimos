...
A1Z_JOINT_NAMES = (*joint_names(A1Z_DOF, prefix="arm_joint"), "arm/gripper")

# Vendor command limits. The gripper position is represented in meters.
...
# Faster demonstrations are time-scaled rather than clipped or rejected.
...
def prepare_episode(
    ...
    *,
    ...
    # Smooth on the uniform grid. Irregular recorder spacing otherwise creates
    # artificial acceleration spikes after interpolation.
...
def _smooth_uniform(
    ...
    *,
    ...
    """Apply a zero-phase moving average to uniformly sampled positions."""
