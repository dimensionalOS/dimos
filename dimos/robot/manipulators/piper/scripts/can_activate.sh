#!/bin/bash
# Vendored helper; functional body retained unchanged from upstream.
# Copyright (c) Agilex Robotice Co., Ltd.
# SPDX-License-Identifier: MIT
# See LICENSE in this directory for the full license text.
# Source: https://raw.githubusercontent.com/agilexrobotics/piper_sdk/4eddfcf8/can_activate.sh
# Upstream commit: 4eddfcf8 (blob SHA-1: 60cc95e7ea51da662884a7400f563bcdef5af9b8)
