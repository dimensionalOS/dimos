...
from dimos.robot.catalog.piper import PIPER_ARM_FK_MODEL, piper as _catalog_piper
...
keyboard_teleop_piper = autoconnect(
    KeyboardTeleopModule.blueprint(model_path=PIPER_ARM_FK_MODEL, ee_joint_id=_piper_cfg.dof),
