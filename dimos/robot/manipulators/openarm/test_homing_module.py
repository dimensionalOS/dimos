...
def test_home_pose_covers_all_arm_joints() -> None:
    ...
    assert OPENARM_HOME_POSITIONS["left_arm/joint4"] == 0.0
    assert OPENARM_HOME_POSITIONS["right_arm/joint4"] == 0.0
...
def test_missing_joint_positions_do_not_execute(module: OpenArmHomingModule) -> None:
    module._control_coordinator.get_joint_positions.return_value = {"left_arm/joint1": 0.0}
