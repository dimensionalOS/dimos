...
class R1ProReplay(Module):
    ...
    # The head is an RGB stereo pair with no depth of its own, so a recording
    # made for the kronknav blueprint has to carry both eyes and both
    # calibrations; StereoCloud rebuilds the depth from them on replay exactly
    # as it does live.
