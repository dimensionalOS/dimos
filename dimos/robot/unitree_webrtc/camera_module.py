...
class UnitreeCameraModule(Module):
    ...
    Publishes:
        ...
        - /go2/depth_colorized: Colorized depth images with statistics overlay (optional)
    ...
    def __init__(
        ...
        publish_colorized_depth: bool = False,
        **kwargs,
    ):
        """
        ...
        Args:
            ...
            publish_colorized_depth: Whether to publish colorized depth images (default: False)
        """
        ...
        self.publish_colorized_depth = publish_colorized_depth
