...
all_blueprints = {
    ...
    "unitree-go2-rust-replay": "dimos.robot.unitree.go2.blueprints.smart.unitree_go2_rust_replay:unitree_go2_rust_replay",
...
all_modules = {
    ...
    "go2-replay-support": "dimos.robot.unitree.go2.blueprints.smart.unitree_go2_rust_replay.Go2ReplaySupport",
    "go2-rust-replayer": "dimos.robot.unitree.go2.blueprints.smart.unitree_go2_rust_replay.Go2RustReplayer",
    ...
    "rust-replayer": "dimos.experimental.memory.rust_replayer.RustReplayer",
