...
all_blueprints = {
    ...
    "fastlio-livox-replay": "dimos.robot.unitree.go2.blueprints.smart.unitree_go2_fastlio:fastlio_livox_replay",
    ...
    "unitree-go2-fastlio": "dimos.robot.unitree.go2.blueprints.smart.unitree_go2_fastlio:unitree_go2_fastlio",
