...
all_blueprints = {
    ...
    "demo-local-movement": "dimos.navigation.local_movement.demo_local_movement:demo_local_movement",
...
all_modules = {
    ...
    "local-movement": "dimos.navigation.local_movement.local_movement",
