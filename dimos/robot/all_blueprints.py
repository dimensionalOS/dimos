...
all_blueprints = {
    ...
    "unitree-go2-mcp": "dimos.robot.unitree.go2.blueprints.agentic.unitree_go2_mcp:unitree_go2_mcp",
...
all_modules = {
    ...
    "navigation-stop-skill": "dimos.agents.skills.navigation_stop.NavigationStopSkill",
