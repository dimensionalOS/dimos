...
all_modules = {
    ...
    "port-control-coordinator": "dimos.control.port_coordinator.PortControlCoordinator",
    "port-teleop-control-coordinator": "dimos.control.port_coordinator.PortTeleopControlCoordinator",
