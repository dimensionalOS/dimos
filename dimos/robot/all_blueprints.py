...
all_blueprints = {
    ...
    "unitree-go2-dogops": "dimos.robot.unitree.go2.blueprints.agentic.unitree_go2_dogops:unitree_go2_dogops",
...
all_modules = {
    ...
    "dog-ops-dashboard-module": "dimos.experimental.dogops.dashboard.DogOpsDashboardModule",
    "dog-ops-skill-container": "dimos.experimental.dogops.skills.DogOpsSkillContainer",
