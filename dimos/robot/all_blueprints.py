...
all_blueprints = {
    ...
    "fastlio-livox-replay": "dimos.robot.unitree.go2.blueprints.smart.unitree_go2_backpack:fastlio_livox_replay",
    ...
    "unitree-go2-backpack": "dimos.robot.unitree.go2.blueprints.smart.unitree_go2_backpack:unitree_go2_backpack",
