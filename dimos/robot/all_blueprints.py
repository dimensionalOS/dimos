...
all_blueprints = {
    ...
    "drone-agentic": "dimos.robot.drone.dji.blueprints.agentic.drone_agentic:drone_agentic",
    "drone-basic": "dimos.robot.drone.dji.blueprints.basic.drone_basic:drone_basic",
    ...
    "px4-basic": "dimos.robot.drone.px4.blueprints.basic.px4_basic:px4_basic",
    "px4-flight-debug": "dimos.robot.drone.px4.blueprints.basic.debug:px4_flight_debug",
    "px4-gazebo-harmonic": "dimos.robot.drone.px4.blueprints.basic.debug:px4_gazebo_harmonic",
    "px4-mapping-debug": "dimos.robot.drone.px4.blueprints.basic.debug:px4_mapping_debug",
    "px4-video-debug": "dimos.robot.drone.px4.blueprints.basic.debug:px4_video_debug",
...
all_modules = {
    ...
    "drone-camera-module": "dimos.robot.drone.dji.camera_module.DroneCameraModule",
    "drone-connection-module": "dimos.robot.drone.dji.connection_module.DroneConnectionModule",
    "drone-tracking-module": "dimos.robot.drone.dji.drone_tracking_module.DroneTrackingModule",
    ...
    "flight-controller": "dimos.robot.drone.px4.flight_control.FlightController",
    ...
    "mid360-mount-static-tf": "dimos.robot.drone.px4.mid360_mount_tf.Mid360MountStaticTf",
    ...
    "px4-gst-tee-camera": "dimos.robot.drone.px4.gstreamer.gstreamer_tee_camera.Px4GstTeeCamera",
