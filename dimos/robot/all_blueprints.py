...
all_blueprints = {
    ...
    "unitree-go2-seat-guide": "dimos.robot.unitree.go2.blueprints.agentic.unitree_go2_seat_guide:unitree_go2_seat_guide",
    "unitree-go2-seat-guide-agentic": "dimos.robot.unitree.go2.blueprints.agentic.unitree_go2_seat_guide_agentic:unitree_go2_seat_guide_agentic",
...
all_modules = {
    ...
    "camera-seat-observation-provider": "dimos.agents.skills.seat_guide.CameraSeatObservationProvider",
    ...
    "seat-guide-skill-container": "dimos.agents.skills.seat_guide.SeatGuideSkillContainer",
    ...
    "synthetic-seat-observation-provider": "dimos.agents.skills.seat_guide.SyntheticSeatObservationProvider",
