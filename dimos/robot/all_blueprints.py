...
all_blueprints = {
    ...
    "px4-agentic": "dimos.robot.drone.px4.blueprints.agentic.px4_agentic:px4_agentic",
    "px4-basic": "dimos.robot.drone.px4.blueprints.basic.px4_basic:px4_basic",
    "px4-gazebo-harmonic": "dimos.robot.drone.px4.blueprints.basic.px4_basic:px4_gazebo_harmonic",
...
all_modules = {
    ...
    "gs-tee-camera": "dimos.robot.drone.px4.gstreamer_tee_camera.GsTeeCamera",
