...
all_blueprints = {
    ...
    "r1pro-calibration-recorder": "dimos.robot.galaxea.r1pro.blueprints.basic.r1pro_recorder:r1pro_calibration_recorder",
    ...
    "r1pro-stereo": "dimos.robot.galaxea.r1pro.blueprints.basic.r1pro_stereo:r1pro_stereo",
...
all_modules = {
    ...
    "stereo-cloud": "dimos.hardware.sensors.camera.depth_cloud.module.StereoCloud",
