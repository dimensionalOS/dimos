...
all_blueprints = {
    ...
    "unitree-go2-visual-relocalization": "dimos.robot.unitree.go2.blueprints.smart.unitree_go2:unitree_go2_visual_relocalization",
...
all_modules = {
    ...
    "visual-relocalization-module": "dimos.perception.fiducial.visual_relocalization_module.VisualRelocalizationModule",
