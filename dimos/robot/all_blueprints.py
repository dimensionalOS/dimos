...
all_modules = {
    ...
    "baseline-pgo": "dimos.navigation.jnav.components.loop_closure.baseline_pgo.module.BaselinePGO",
    ...
    "graph-capture": "dimos.navigation.jnav.components.loop_closure.gsc_pgo.utils.replay.GraphCapture",
    ...
    "gsc-pgo": "dimos.navigation.jnav.components.loop_closure.gsc_pgo.module.GscPGO",
    ...
    "ivan-pgo": "dimos.navigation.jnav.components.loop_closure.ivan_pgo_module.IvanPGO",
    ...
    "lockstep-replay": "dimos.navigation.jnav.components.loop_closure.gsc_pgo.utils.replay.LockstepReplay",
    ...
    "normalize-go2-lidar": "dimos.robot.unitree.go2.normalize_go2_lidar.NormalizeGo2Lidar",
