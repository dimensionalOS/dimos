...
all_blueprints = {
    ...
    "unitree-go2-companion-alert": "dimos.robot.unitree.go2.blueprints.agentic.unitree_go2_companion_alert:unitree_go2_companion_alert",
...
all_modules = {
    ...
    "browser-notification-skill": "dimos.agents.skills.browser_notification_skill.BrowserNotificationSkill",
