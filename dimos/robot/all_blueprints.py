...
all_modules = {
    ...
    "movement-manager": "dimos.navigation.nav_stack.modules.movement_manager.movement_manager.MovementManager",
    ...
    "tui-control-module": "dimos.navigation.nav_stack.modules.tui_control.tui_control.TUIControlModule",
