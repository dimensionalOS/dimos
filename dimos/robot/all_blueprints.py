...
all_blueprints = {
    ...
    "drop-in-guide": "dimos.robot.unitree.go2.blueprints.agentic.drop_in_guide:drop_in_guide",
...
all_modules = {
    ...
    "scene-caption-skill": "dimos.experimental.scene_caption_skill.SceneCaptionSkill",
