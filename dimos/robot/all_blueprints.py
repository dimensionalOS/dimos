...
all_blueprints = {
    ...
    "unitree-go2-agentic-record": "dimos.robot.unitree.go2.blueprints.agentic.unitree_go2_agentic_record:unitree_go2_agentic_record",
...
all_modules = {
    ...
    "episode-recording-skill-container": "dimos.agents.skills.episode_recording.EpisodeRecordingSkillContainer",
    ...
    "go2-collection-recorder": "dimos.learning.collection.go2_recorder.Go2CollectionRecorder",
