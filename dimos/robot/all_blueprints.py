...
all_blueprints = {
    ...
    "unitree-go2-relocalization-fiducial": "dimos.robot.unitree.go2.blueprints.smart.unitree_go2:unitree_go2_relocalization_fiducial",
    "unitree-go2-relocalization-lidar": "dimos.robot.unitree.go2.blueprints.smart.unitree_go2:unitree_go2_relocalization_lidar",
    "unitree-go2-relocalization-lidar-fiducial": "dimos.robot.unitree.go2.blueprints.smart.unitree_go2:unitree_go2_relocalization_lidar_fiducial",
...
all_modules = {
    ...
    "reloc-eval": "dimos.mapping.relocalization.eval_module.RelocEval",
