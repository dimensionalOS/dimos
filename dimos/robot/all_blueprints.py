...
all_blueprints = {
    ...
    "r1pro-quest-teleop": "dimos.robot.galaxea.r1pro.blueprints.manipulation.quest_teleop:r1pro_quest_teleop",
    "r1pro-quest-teleop-arms-only": "dimos.robot.galaxea.r1pro.blueprints.manipulation.quest_teleop:r1pro_quest_teleop_arms_only",
    ...
    "teleop-quest-go2": "dimos.robot.unitree.go2.blueprints.basic.go2_quest_teleop:teleop_quest_go2",
...
all_modules = {
    ...
    "camera-pair-select-module": "dimos.teleop.hosted.camera_pair.CameraPairSelectModule",
    ...
    "head-left-decode": "dimos.robot.galaxea.r1pro.blueprints.manipulation.hosted_teleop.HeadLeftDecode",
    "head-right-decode": "dimos.robot.galaxea.r1pro.blueprints.manipulation.hosted_teleop.HeadRightDecode",
    ...
    "mjpeg-preview-module": "dimos.teleop.hosted.mjpeg_preview.MjpegPreviewModule",
    ...
    "r1-pro-ready-pose-module": "dimos.robot.galaxea.r1pro.ready_pose.R1ProReadyPoseModule",
    "r1-pro-teleop-coordinator": "dimos.robot.galaxea.r1pro.blueprints.manipulation.hosted_teleop.R1ProTeleopCoordinator",
    ...
    "wrist-left-camera": "dimos.robot.galaxea.r1pro.blueprints.manipulation.hosted_teleop.WristLeftCamera",
    "wrist-right-camera": "dimos.robot.galaxea.r1pro.blueprints.manipulation.hosted_teleop.WristRightCamera",
