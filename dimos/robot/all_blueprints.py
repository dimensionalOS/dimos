...
all_blueprints = {
    ...
    "unitree-go2-agentic-locations": "dimos.robot.unitree.go2.blueprints.agentic.unitree_go2_locations:unitree_go2_agentic_locations",
...
all_modules = {
    ...
    "location-memory": "dimos.memory2.location_module.LocationMemory",
