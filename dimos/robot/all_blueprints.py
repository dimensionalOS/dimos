...
all_blueprints = {
    ...
    "go2-marauders-map": "dimos.apps.marauders_map.blueprint:go2_marauders_map",
...
all_modules = {
    ...
    "patrol-module": "dimos.robot.unitree.go2.blueprints.smart.unitree_go2_patrol.PatrolModule",
    ...
    "reid-map-module": "dimos.apps.marauders_map.module.ReidMapModule",
    ...
    "spatial-target-lock-module": "dimos.robot.custom.modules.spatial_target_lock_module.SpatialTargetLockModule",
    ...
    "target-standoff-behavior-module": "dimos.robot.custom.tasks.target_standoff_behavior_module.TargetStandoffBehaviorModule",
