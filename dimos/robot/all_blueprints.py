...
all_blueprints = {
    ...
    "microduck-agentic-cockpit": "dimos.robot.pollen.microduck.blueprints.cockpit:microduck_agentic_cockpit",
    "microduck-cockpit": "dimos.robot.pollen.microduck.blueprints.cockpit:microduck_cockpit",
...
all_modules = {
    ...
    "microduck-skills": "dimos.robot.pollen.microduck.skills.MicroduckSkills",
