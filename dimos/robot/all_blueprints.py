...
all_modules = {
    ...
    "policy-module": "dimos.manipulation.policy.module.PolicyModule",
    "quest-episode-boundary": "dimos.manipulation.data_collection.quest_episode_boundary.QuestEpisodeBoundary",
    "quest-rollout-toggle": "dimos.manipulation.policy.quest_rollout_toggle.QuestRolloutToggle",
    ...
    "rerun-data-recorder": "dimos.manipulation.data_collection.recorder.RerunDataRecorder",
