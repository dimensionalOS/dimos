...
all_blueprints = {
    "agent-mcp": "dimos.agents.agent_mcp:agent_mcp",
    ...
    "unitree-go2-scene": "dimos.robot.unitree.go2.blueprints.smart.unitree_go2_scene:unitree_go2_scene",
...
all_modules = {
    ...
    "floorplan-skill-container": "dimos.skills.mapping.floorplan_skill.FloorplanSkillContainer",
    ...
    "lidar-signal-skills": "dimos.skills.mapping.lidar_signal_skills.LidarSignalSkills",
