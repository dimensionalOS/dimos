...
all_blueprints = {
    ...
    "unitree-g1-nav-mujoco-sim": "dimos.robot.unitree.g1.blueprints.navigation.unitree_g1_nav_mujoco_sim:unitree_g1_nav_mujoco_sim",
...
all_modules = {
    ...
    "b-box-navigation-module": "dimos.navigation.utils.bbox_navigation.BBoxNavigationModule",
    ...
    "cost-mapper": "dimos.mapping.modules.cost_mapper.cost_mapper.CostMapper",
    ...
    "far-planner": "dimos.navigation.modules.far_planner.far_planner.FarPlanner",
    ...
    "local-planner": "dimos.navigation.modules.local_planner.local_planner.LocalPlanner",
    ...
    "movement-manager": "dimos.navigation.modules.movement_manager.movement_manager.MovementManager",
    "mujoco-pose-to-odometry-adapter": "dimos.robot.unitree.g1.blueprints.navigation._mujoco_pose_adapter.MujocoPoseToOdometryAdapter",
    "mujoco-sim-module": "dimos.simulation.engines.mujoco_sim_module.MujocoSimModule",
    "nav-record": "dimos.navigation.modules.nav_record.nav_record.NavRecord",
    "nav-test-probe": "dimos.navigation.tests._nav_probe.NavTestProbe",
    ...
    "path-follower": "dimos.navigation.modules.path_follower.path_follower.PathFollower",
    "patrolling-module": "dimos.navigation.modules.patrolling.module.PatrollingModule",
    ...
    "pgo": "dimos.navigation.modules.pgo.pgo.PGO",
    ...
    "replanning-a-star-planner": "dimos.navigation.modules.replanning_a_star.module.ReplanningAStarPlanner",
    ...
    "simple-planner": "dimos.navigation.modules.simple_planner.simple_planner.SimplePlanner",
    "spatial-memory": "dimos.perception.spatial_perception.SpatialMemory",
    "speak-skill": "dimos.agents.skills.speak_skill.SpeakSkill",
    "tare-planner": "dimos.navigation.modules.tare_planner.tare_planner.TarePlanner",
    "temporal-memory": "dimos.perception.experimental.temporal_memory.temporal_memory.TemporalMemory",
    "terrain-analysis": "dimos.navigation.modules.terrain_analysis.terrain_analysis.TerrainAnalysis",
    "terrain-map-ext": "dimos.navigation.modules.terrain_map_ext.terrain_map_ext.TerrainMapExt",
    ...
    "voxel-grid-mapper": "dimos.mapping.modules.voxels.voxels.VoxelGridMapper",
    "wavefront-frontier-explorer": "dimos.navigation.modules.frontier_exploration.wavefront_frontier_goal_selector.WavefrontFrontierExplorer",
