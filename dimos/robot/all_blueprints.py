...
all_blueprints = {
    ...
    "webcam-optical-flow": "dimos.perception.optical_flow.blueprints:webcam_optical_flow",
...
all_modules = {
    ...
    "optical-flow-module": "dimos.perception.optical_flow.optical_flow_module.OpticalFlowModule",
