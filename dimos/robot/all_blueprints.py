...
all_modules = {
    ...
    "drone-recorder": "dimos.robot.drone.blueprints.basic.drone_basic.DroneRecorder",
    ...
    "go2-memory": "dimos.robot.unitree.go2.blueprints.basic.unitree_go2_basic.Go2Memory",
