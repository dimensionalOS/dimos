...
all_blueprints = {
    ...
    "r1pro-full-with-torso": "dimos.robot.humanoids.r1pro.blueprints:r1pro_full_with_torso",
    "r1pro-planner-coordinator": "dimos.robot.humanoids.r1pro.blueprints:r1pro_planner_coordinator",
    "r1pro-planner-full": "dimos.robot.humanoids.r1pro.blueprints:r1pro_planner_full",
    "r1pro-upper-body-full": "dimos.robot.humanoids.r1pro.blueprints:r1pro_upper_body_full",
    "r1pro-upper-body-mock": "dimos.robot.humanoids.r1pro.blueprints:r1pro_upper_body_mock",
    "r1pro-whole-body-full": "dimos.robot.humanoids.r1pro.blueprints:r1pro_whole_body_full",
