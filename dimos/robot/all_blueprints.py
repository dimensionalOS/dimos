...
all_blueprints = {
    ...
    "unitree-g1-groot-wbc-manip": "dimos.robot.unitree.g1.blueprints.basic.unitree_g1_groot_wbc_manip:unitree_g1_groot_wbc_manip",
    ...
    "unitree-g1-water-demo-sim": "dimos.robot.unitree.g1.blueprints.basic.unitree_g1_water_demo_sim:unitree_g1_water_demo_sim",
...
all_modules = {
    ...
    "g1-head-camera-tf": "dimos.robot.unitree.g1.head_camera_tf.G1HeadCameraTf",
    ...
    "g1-lio-base-pose": "dimos.robot.unitree.g1.lio_base_pose.G1LioBasePose",
    "g1-sim-connection": "dimos.robot.unitree.g1.mujoco_sim.G1SimConnection",
    "g1-watering-spout-tf": "dimos.robot.unitree.g1.watering_task.G1WateringSpoutTf",
    ...
    "holonomic-path-follower": "dimos.navigation.holonomic_path_follower.module.HolonomicPathFollower",
    ...
    "marker-latch-module": "dimos.perception.fiducial.marker_latch_module.MarkerLatchModule",
    ...
    "pose-target-observation-module": "dimos.manipulation.mobile.pose_target_observation_module.PoseTargetObservationModule",
    ...
    "watering-task-module": "dimos.robot.unitree.g1.watering_task.WateringTaskModule",
