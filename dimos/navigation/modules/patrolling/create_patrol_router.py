...
def create_patrol_router(name: PatrolRouterName, clearance_radius_m: float) -> PatrolRouter:
    match name:
        case "random":
            ...
            from dimos.navigation.modules.patrolling.routers.random_patrol_router import (
                RandomPatrolRouter,
            )
        ...
        case "coverage":
            # Inline to avoid unnecessary imports.
            from dimos.navigation.modules.patrolling.routers.coverage_patrol_router import (
        ...
        case "frontier":
            # Inline to avoid unnecessary imports.
            from dimos.navigation.modules.patrolling.routers.frontier_patrol_router import (
