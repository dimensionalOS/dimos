...
def main() -> None:
    ...
    from dimos.memory.vis.plot.elements import HLine, Series
    ...
    # The axes go unlabelled -- this Plot takes no xlabel/ylabel -- so the header
    # printed above the table is what says which is which.
