...
- Codecs — codec_for() selects CdrCodec for generated messages, including raw Image and explicit CompressedImage values. Python objects use PickleCodec. SQLite can wrap CDR in LZ4; MCAP uses chunk compression.
