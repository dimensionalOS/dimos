...
# Mirrors the OpenArm v2.0 limits from openarm_v20_bimanual.urdf. The
# sender-side clamp improves teleop behavior; the follower/control stack
# remains defensive.
...
def map_side_readings(
    ...
    *,
    ...
    follower_joint_names = tuple(target_joint_names or openarm_arm_joints(side))
