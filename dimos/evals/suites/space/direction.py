...
"""SPACE DirectionEstimation — at what angle is landmark B, pretending you face landmark A?
...
600 questions per presentation. The questions carry their own instructions (persona, choices, JSON answer
...
SUITE: Suite = qa_suite("DirectionEstimation", "direction")
