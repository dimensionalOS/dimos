...
"""SPACE shortcut discovery — the walkthrough detours; find the shortcut it never showed (upstream key: "walkthrough").
...
says so on machines without it::
    ...
    dimos evals run dimos.evals.suites.space.shortcut_discovery --tags bevimage --limit 5 --system-prompt ""
...
SUITE: Suite = nav_suite("walkthrough", "shortcut_discovery")
