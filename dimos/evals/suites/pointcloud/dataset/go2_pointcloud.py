...
:mod:`dimos.evals.suites.pointcloud.dataset.go2_pointcloud_clearance` and
:mod:`dimos.evals.suites.pointcloud.dataset.go2_pointcloud_route`.

Regenerate (needs both recordings)::

    uv run python -m dimos.evals.suites.pointcloud.dataset.go2_pointcloud
"""
