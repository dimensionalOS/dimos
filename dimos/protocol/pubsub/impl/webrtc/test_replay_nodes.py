...
from dimos.protocol.pubsub.impl.webrtc import replay_nodes
...
def test_recommendation_selects_fastest_healthy_node(
    ...
    monkeypatch.setattr(replay_nodes, "probe_node", fake_probe)
...
def test_load_nodes_and_choose_server_from_environment(
    ...
    monkeypatch.setattr(
        replay_nodes,
        "recommend_node",
        lambda _: replay_nodes.NodeRecommendation(
            selected=nodes[1],
            detected_region="us",
            measured_at=0.0,
            probes=(),
