...
from dimos.memory2 import remote_replay
from dimos.memory2.remote_replay import (
...
def test_resolve_remote_replay_downloads_and_reuses_cache(
    ...
    monkeypatch.setattr(remote_replay, "download_object", fake_download)
...
def test_remote_memory2_http_round_trip(tmp_path: Path) -> None:
    source = _memory2_database(tmp_path / "go2.db")
...
def test_local_replay_uses_existing_resolver(
    ...
    monkeypatch.setattr(remote_replay, "_resolve_local_replay", lambda _: expected)
