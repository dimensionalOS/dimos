...
def test_set_gps_travel_points(create_gps_nav_agent, gps_nav_skill_container, mocker):
...
def test_set_gps_travel_points_multiple(create_gps_nav_agent, gps_nav_skill_container, mocker):
    gps_nav_skill_container._latest_location = LatLon(lat=37.782654, lon=-122.413273)
    gps_nav_skill_container._set_gps_travel_goal_points = mocker.Mock()
