...
"""T2 statics against the REAL PureModule (spec t2-config.md §13.2).
...
errors are pinned against production. Real-surface import is allowed per
t4-typing.md §7.5 rule 1 (surface now implemented).
