...
| T13 graph | planning — PureGraph composition layer; charter is `puregraph_api_sketch.py` | `pure/spec-t13-graph` |
...
dimos/pure/
  ...
  health.py        # T9
  checkpoint.py    # T10
  tfbuffer.py      # T11  (NOT tf.py — would clobber pm.tf; t11-tf.md §18.1)
```
