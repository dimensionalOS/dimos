...
/// Read the single config line the coordinator writes to stdin.
pub(crate) async fn read_stdin_config() -> io::Result<serde_json::Value> {
    ...
    T: Transport,
{
    ...
    let json = read_stdin_config().await?;
