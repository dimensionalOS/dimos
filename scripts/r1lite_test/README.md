...
Robot-side ROS 2 validation for the Galaxea R1 Lite, originally ported from
Mustafa's R1 Pro bring-up suite (`scripts/r1pro_test/`, tracked separately
on the R1 Pro integration branch). These
