...
"""Deterministic answer-leak gate: the evo target (PointCloud2.py) must not
reference the benchmark, its rows, or hardcode row answers. Exits non-zero
on a hit."""
...
FORBIDDEN_SUBSTRINGS = ["evals_bench", "rows.json", "go2_short"]
