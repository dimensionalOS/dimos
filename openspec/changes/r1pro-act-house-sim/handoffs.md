...
### Random-object ACT implementation started

User approved execution with ACT mandatory and sparse training checks. Detailed continuation is in handoffs-random-objects.md. Initial physical teacher validation passed 15/15 picks over eight randomized layouts; camera collection and a five-update train/export/runtime smoke passed. The full persistent job is recordings/r1pro-act-task/jobs/random-objects-act-v1 (supervisor 678343, five-minute monitor 681775). It is collecting 64 layouts before 10,000 updates and held-out evaluation. No trained random-object policy is ready or deployed yet. Existing work was checkpointed as 14f90296c6; main rebase encountered historical dependency conflicts and was aborted cleanly. New code, native integration, model acceptance and publishing status are tracked in the dedicated handoff.
