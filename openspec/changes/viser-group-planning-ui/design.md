...
- The module-global stored plan can still be replaced by another caller between the UI freshness check and execution. Closing this race requires an opaque plan token and is outside this change.
