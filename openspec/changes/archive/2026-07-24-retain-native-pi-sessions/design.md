...
- Add the narrow one-run visualization-forbidden precursor check without changing normal experiment execution.
...
- No change to unrelated `pi-spatial-agent-baseline` execution behavior.
