...
The first implementation milestone SHALL deliver a running refactored structure with full support for all current Drake-backed manipulation features before MPlib is added.
