...
Define the private, typed, versioned DimSim scene oracle boundary used to generate objective benchmark tasks from coherent runtime state and approved semantic profiles.
