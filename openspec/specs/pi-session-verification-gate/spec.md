# pi-session-verification-gate Specification

## Purpose
TBD - created by archiving change retain-native-pi-sessions. Update Purpose after archive.
## Requirements
...
### Requirement: Require the visualization-forbidden precursor check
One visualization-forbidden precursor run SHALL require an accepted submission, normal scoring with correctness not required, a complete matching receipt and hash for a valid native session, and successful pinned Pi export.
...
- **THEN** the precursor check passes
